...
parser.add_argument('-o','--outfile',action='store',type=str,required=True,help='Path to Output directory')
...
fig = px.scatter_3d(tsneArr, x=0,y=1,z=2,color=test_la,labels=test_la)
fig.update_traces(marker_size=2)
#fig.show()
import plotly.io as po
po.write_html(fig, file='./'+args.outfile+'/manifold3D.html')
